...
<div class="max-w-3xl mx-auto px-4 sm:px-0 py-6">
    ...
    <div class="flex items-start justify-between gap-4 mb-6">
        <div class="min-w-0">
            <h1 class="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">Ajouter un Technicien</h1>
            <p class="text-sm text-slate-500 mt-1">Créez un compte technicien.</p>
        </div>
    ...
    <form action="{{ route('admin.technicians.store') }}" method="POST"
       ...
       pattern="0[67][0-9]{8}"
            ...
            {{-- ✅ Email --}}
            <label class="block">
                <span class="text-xs font-extrabold text-slate-500 uppercase tracking-wide">Email *</span>
                ...
                <input type="email"
                       ...
                       required
                       class="mt-2 w-full px-4 py-3 rounded-2xl border bg-white
                              {{ $errors->has('email') ? 'border-rose-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500' : 'border-slate-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500' }}"
            ...
            {{-- ✅ Password --}}
            <label class="block">
                <span class="text-xs font-extrabold text-slate-500 uppercase tracking-wide">Mot de passe *</span>
